...
import (
	...
	"git.portals-mem.com/portals/backend/db.git/v3/river"
...
func NewMockWorker[T river0.JobArgs](t interface {
	mock.TestingT
	Cleanup(func())
}) *MockWorker[T] {
	mock := &MockWorker[T]{}
...
type MockWorker[T river0.JobArgs] struct {
	mock.Mock
}

type MockWorker_Expecter[T river0.JobArgs] struct {
	mock *mock.Mock
}
...
// DeleteJobs provides a mock function for the type MockWorker
func (_mock *MockWorker[T]) DeleteJobs(ctx context.Context, ids ...int64) error {
	var tmpRet mock.Arguments
	if len(ids) > 0 {
		tmpRet = _mock.Called(ctx, ids)
	} else {
...
// MockWorker_DeleteJobs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DeleteJobs'
type MockWorker_DeleteJobs_Call[T river0.JobArgs] struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - ids ...int64
func (_e *MockWorker_Expecter[T]) DeleteJobs(ctx interface{}, ids ...interface{}) *MockWorker_DeleteJobs_Call[T] {
	return &MockWorker_DeleteJobs_Call[T]{Call: _e.mock.On("DeleteJobs",
		append([]interface{}{ctx}, ids...)...)}
}

func (_c *MockWorker_DeleteJobs_Call[T]) Run(run func(ctx context.Context, ids ...int64)) *MockWorker_DeleteJobs_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockWorker_DeleteJobs_Call[T]) Return(err error) *MockWorker_DeleteJobs_Call[T] {
	_c.Call.Return(err)
	return _c
}

func (_c *MockWorker_DeleteJobs_Call[T]) RunAndReturn(run func(ctx context.Context, ids ...int64) error) *MockWorker_DeleteJobs_Call[T] {
	_c.Call.Return(run)
	return _c
}
...
type MockWorker_FetchJob_Call[T river0.JobArgs] struct {
	*mock.Call
}
...
type MockWorker_FetchJobs_Call[T river0.JobArgs] struct {
	*mock.Call
}
...
func (_mock *MockWorker[T]) JobStatuses(ctx context.Context, ids ...int64) ([]river.JobStatus, error) {
	var tmpRet mock.Arguments
	if len(ids) > 0 {
		tmpRet = _mock.Called(ctx, ids)
	} else {
	...
	var r0 []river.JobStatus
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, ...int64) ([]river.JobStatus, error)); ok {
		return returnFunc(ctx, ids...)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, ...int64) []river.JobStatus); ok {
		r0 = returnFunc(ctx, ids...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]river.JobStatus)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, ...int64) error); ok {
		r1 = returnFunc(ctx, ids...)
...
type MockWorker_JobStatuses_Call[T river0.JobArgs] struct {
	*mock.Call
}
...
func (_c *MockWorker_JobStatuses_Call[T]) Return(jobStatuss []river.JobStatus, err error) *MockWorker_JobStatuses_Call[T] {
	_c.Call.Return(jobStatuss, err)
	return _c
}

func (_c *MockWorker_JobStatuses_Call[T]) RunAndReturn(run func(ctx context.Context, ids ...int64) ([]river.JobStatus, error)) *MockWorker_JobStatuses_Call[T] {
	_c.Call.Return(run)
	return _c
}
...
type MockWorker_Put_Call[T river0.JobArgs] struct {
	*mock.Call
}
...
type MockWorker_PutBatch_Call[T river0.JobArgs] struct {
	*mock.Call
}
...
func (_mock *MockWorker[T]) PutBatchWithOpts(ctx context.Context, options river.Options, args ...T) ([]int64, error) {
	var tmpRet mock.Arguments
	if len(args) > 0 {
	...
	var r0 []int64
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, river.Options, ...T) ([]int64, error)); ok {
		return returnFunc(ctx, options, args...)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, river.Options, ...T) []int64); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, river.Options, ...T) error); ok {
...
type MockWorker_PutBatchWithOpts_Call[T river0.JobArgs] struct {
	*mock.Call
}
...
func (_c *MockWorker_PutBatchWithOpts_Call[T]) Run(run func(ctx context.Context, options river.Options, args ...T)) *MockWorker_PutBatchWithOpts_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 river.Options
		if args[1] != nil {
			arg1 = args[1].(river.Options)
		}
		var arg2 []T
		var variadicArgs []T
		if len(args) > 2 {
...
func (_c *MockWorker_PutBatchWithOpts_Call[T]) RunAndReturn(run func(ctx context.Context, options river.Options, args ...T) ([]int64, error)) *MockWorker_PutBatchWithOpts_Call[T] {
	_c.Call.Return(run)
	return _c
}
...
type MockWorker_PutWithOpts_Call[T river0.JobArgs] struct {
	*mock.Call
}
...
func (_c *MockWorker_PutWithOpts_Call[T]) Run(run func(ctx context.Context, options river.Options, args T)) *MockWorker_PutWithOpts_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
